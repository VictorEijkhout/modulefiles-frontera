...
setenv( "LMOD_JSONC_INC",     pathJoin("/work2/00434/eijkhout/jsonc/installation-jsonc-git-clx-gcc13","include")   )
setenv( "TACC_JSONC_LIB",     pathJoin("/work2/00434/eijkhout/jsonc/installation-jsonc-git-clx-gcc13","lib64")   )
setenv( "LMOD_JSONC_LIB",     pathJoin("/work2/00434/eijkhout/jsonc/installation-jsonc-git-clx-gcc13","lib64")   )
prepend_path( "LD_LIBRARY_PATH",pathJoin("/work2/00434/eijkhout/jsonc/installation-jsonc-git-clx-gcc13","lib64")   )
prepend_path( "PKG_CONFIG_PATH", 
                  pathJoin( "/work2/00434/eijkhout/jsonc/installation-jsonc-git-clx-gcc13","lib64","pkgconfig" ) )
