...
prepend_path( "PKG_CONFIG_PATH", 
                  pathJoin( "/work2/00434/eijkhout/petsc/installation-petsc-3.19.5-clx-gcc9-impi","lib","pkgconfig" ) )
setenv( "PETSC_DIR", "/work2/00434/eijkhout/petsc/installation-petsc-3.19.5-clx-gcc9-impi" )
setenv( "PETSC_ARCH", "clx-gcc9-impi" )
prepend_path( "PYTHONPATH", "/work2/00434/eijkhout/petsc/installation-petsc-3.19.5-clx-gcc9-impi/lib" )
