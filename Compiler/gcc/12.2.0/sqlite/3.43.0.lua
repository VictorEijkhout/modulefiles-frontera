...
prepend_path( "PATH",           pathJoin("/work2/00434/eijkhout/sqlite/installation-sqlite-3.43.0-clx-gcc12","bin")   )
setenv( "LMOD_SQLITE_BIN",     pathJoin("/work2/00434/eijkhout/sqlite/installation-sqlite-3.43.0-clx-gcc12","bin")   )
setenv( "TACC_SQLITE_BIN",     pathJoin("/work2/00434/eijkhout/sqlite/installation-sqlite-3.43.0-clx-gcc12","bin")   )
