...
prepend_path( "PKG_CONFIG_PATH",                 pathJoin( "/work2/00434/eijkhout/eigen/installation-eigen-3.4.0-clx-gcc13","share/pkgconfig" ) )
prepend_path( "CMAKE_PREFIX_PATH", "/work2/00434/eijkhout/eigen/installation-eigen-3.4.0-clx-gcc13" )
